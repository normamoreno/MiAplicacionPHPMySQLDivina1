...
public class MySQLQuestion extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MySQLHelper db = new MySQLHelper(this);  // Mi clase de banco de preguntas
    ...
    public void getAnswer(String AnswerString) {
        ...
        if (qid < 5) {
            ...
            Intent intent = new Intent(MySQLQuestion.this,
