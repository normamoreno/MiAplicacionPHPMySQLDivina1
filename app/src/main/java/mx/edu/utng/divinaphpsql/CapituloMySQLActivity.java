 ...
 */
public class CapituloMySQLActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        modulo1.setText(R.string.capitulo_queesmysql);
        modulo2.setText(R.string.capitulo_porquemysql);
        modulo3.setText(R.string.capitulo_sentenciasmysql);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.itm_menu_bar_desarrollador:
                ...
                intent=new Intent(CapituloMySQLActivity.this,DesarrolladorActivity.class);
                intent.putExtras(bundle);
                startActivity(intent);
                break;
            case R.id.itm_menu_bar_universidad:
                intent=new Intent(CapituloMySQLActivity.this,VideoActivity.class);
            ...
            case R.id.itm_menu_bar_Tema:
                startActivity(new Intent(CapituloMySQLActivity.this, TemaActivity.class));
                break;
            case R.id.itm_menu_bar_correo:
                startActivity(new Intent(CapituloMySQLActivity.this, MailActivity.class));
                break;
            case R.id.itm_menu_bar_grafica:
                startActivity(new Intent(CapituloMySQLActivity.this, GraficaMenuActiviry.class));
                break;
            case R.id.itm_menu_bar_juegos:
                startActivity(new Intent(CapituloMySQLActivity.this, Manager.class));
                break;
            case R.id.itm_menu_bar_galery:
                startActivity(new Intent(CapituloMySQLActivity.this, GaleriasActivity.class));
                break;
            case R.id.itm_menu_bar_tools:
                startActivity(new Intent(CapituloMySQLActivity.this, UtileriasActivity.class));
                break;
            case R.id.itm_menu_bar_streaming:
                startActivity(new Intent(CapituloMySQLActivity.this, StreamingMp3Player.class));
                break;
            default:
                break;
        }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.txv_selec1:
                Intent i = new Intent(this, InformacionMySQL.class);
            ...
            case R.id.txv_selec2:
                if (bloqueo >= 4) {
                    i = new Intent(this, InformacionMySQL.class);
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    Intent i = new Intent(CapituloMySQLActivity.this, MySQLQuestion.class).putExtra("Logeado",bundleResivido.getBoolean("Logeado"));
                                    startActivity(i);
                                }
                            }).show();
                } else {
