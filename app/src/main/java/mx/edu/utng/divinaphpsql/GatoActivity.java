...
/**
 * Created by Mauricio on 01/05/2016.
 */
public class GatoActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gato_layout);
    ...
    private void checkForWinner() {
        ...
        if (there_is_a_winner) {
            if (!turn)
                message("Ganó el jugadór uno \"X\"");
            else
                message("Ganó el jugadór dos \"O\"");
