...
import mx.edu.utng.divinaphpsql.SeleccionModuloActivity;
import mx.edu.utng.divinaphpsql.dao.DatabaseHelper;
import mx.edu.utng.divinaphpsql.examen.Question;


public class PHPQuestion extends Activity {
    private Bundle bundleResivido;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("status", "onCreate: "+bundleResivido.getBoolean("Logeado") );
        PHPHelper db = new PHPHelper(this);  // Mi clase de banco de preguntas
    ...
    public void getAnswer(String AnswerString) {
        ...
        if (qid < 5) {
            ...
            Intent intent = new Intent(PHPQuestion.this,
                    SeleccionModuloActivity.class).putExtra("Logeado",bundleResivido.getBoolean("Logeado"));
            helper.actualizarQuiz(score,1);
            helper.actualizarBloqueo(2);
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            Intent intent = new Intent(PHPQuestion.this,
                    SeleccionModuloActivity.class);
            intent.putExtra("Logeado",bundleResivido.getBoolean("Logeado"));
            helper.actualizarQuiz(score, 1);
            helper.actualizarBloqueo(2);
            startActivity(intent);
            finish();
